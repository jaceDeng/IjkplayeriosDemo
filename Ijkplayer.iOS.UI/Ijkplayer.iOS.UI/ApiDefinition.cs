...
namespace Ijkplayer.iOS.UI
{
    ...
    interface ZFPlayerMediaControl
    {
        ...
        void VideoPlayerCurrentTime(ZFPlayerController videoPlayer, double currentTime, double totalTime);
        ...
        void VideoPlayerWillChange(ZFPlayerController videoPlayer, ZFOrientationObserver observer);
        ...
        void VideoPlayerDidChanged(ZFPlayerController videoPlayer, ZFOrientationObserver observer);
    ...
    partial interface UIScrollView//_ZFPlayer
    {
    ...
    // [Category]
    //[BaseType(typeof(UIScrollView))]
    partial interface UIScrollView//_ZFPlayerCannotCalled
    {
    ...
    interface IZFPlayerMediaPlayback { }
    ...
    partial interface ZFPlayerController//_ZFPlayerTimeControl
    {
    ...
    //[Category]
    // [BaseType(typeof(ZFPlayerController))]
    partial interface ZFPlayerController//_ZFPlayerPlaybackControl
    {
    ...
    interface ZFPortraitControlView
    {
        ...
        // @property (nonatomic, weak) int * _Nullable player;
        [NullAllowed, Export("player", ArgumentSemantic.Weak)]
        IntPtr Player { get; set; }
        ...
        // -(void)videoPlayer:(id)videoPlayer currentTime:(NSTimeInterval)currentTime totalTime:(NSTimeInterval)totalTime;
        [Export("videoPlayer:currentTime:totalTime:")]
        void VideoPlayer(NSObject videoPlayer, double currentTime, double totalTime);

        // -(void)videoPlayer:(id)videoPlayer bufferTime:(NSTimeInterval)bufferTime;
        [Export("videoPlayer:bufferTime:")]
        void VideoPlayer(NSObject videoPlayer, double bufferTime);

        // -(BOOL)shouldResponseGestureWithPoint:(CGPoint)point withGestureType:(id)type touch:(UITouch * _Nonnull)touch;
        [Export("shouldResponseGestureWithPoint:withGestureType:touch:")]
        bool ShouldResponseGestureWithPoint(CGPoint point, NSObject type, UITouch touch);

        // -(void)showTitle:(NSString * _Nullable)title fullScreenMode:(id)fullScreenMode;
        [Export("showTitle:fullScreenMode:")]
        void ShowTitle([NullAllowed] string title, NSObject fullScreenMode);
        ...
        void SliderValueChangedCurrentTime(nfloat value, string timeString);
    ...
    interface ZFLandScapeControlView
    {
        ...
        // -(void)videoPlayer:(id)videoPlayer presentationSizeChanged:(CGSize)size;
        [Export("videoPlayer:presentationSizeChanged:")]
        void VideoPlayer(NSObject videoPlayer, CGSize size);
    ...
    interface IZFPlayerMediaControl { }
    ...
    interface ZFPlayerControlView : ZFPlayerMediaControl
    {
        ...
        // -(void)showTitle:(NSString *)title coverURLString:(NSString *)coverUrl fullScreenMode:(id)fullScreenMode;
        [Export("showTitle:coverURLString:fullScreenMode:")]
        void ShowTitle(string title, string coverUrl, NSObject fullScreenMode);

        // -(void)showTitle:(NSString *)title coverURLString:(NSString *)coverUrl placeholderImage:(UIImage *)placeholder fullScreenMode:(id)fullScreenMode;
        [Export("showTitle:coverURLString:placeholderImage:fullScreenMode:")]
        void ShowTitle(string title, string coverUrl, UIImage placeholder, NSObject fullScreenMode);

        // -(void)showTitle:(NSString *)title coverImage:(UIImage *)image fullScreenMode:(id)fullScreenMode;
        [Export("showTitle:coverImage:fullScreenMode:")]
        void ShowTitle(string title, UIImage image, NSObject fullScreenMode);
